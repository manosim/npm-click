  ...
  <div className="container-fluid section-welcome">
    ...
    <div className="row">
      <div className="col-md-4">
        ...
        <p className="lead">
          NPM is awesome! We all use it. Dependencies get updated daily so if
          you want to be up to date, you are at the right place.
        </p>
      </div>
      ...
      <div className="col-md-4">
        ...
        <p className="lead">
          ...
          contents to the text box or use the upload button. Whatever works for
          you. That's all!
        </p>
      </div>
